...
// the negative of the max safe integer

// Exercise 2: why does this throw an error? How can you fix it?
3 + 4 + 1n
// It is adding two different types, change the bigInt (n) to a number or change the numbers to bigInt by adding n
